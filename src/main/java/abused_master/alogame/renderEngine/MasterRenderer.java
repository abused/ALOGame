...
import abused_master.alogame.shaders.TerrainShader;
...
public class MasterRenderer {
    ...
    private static final float RED = 0.690f;
    private static final float GREEN = 0.769f;
    private static final float BLUE = 0.871f;
